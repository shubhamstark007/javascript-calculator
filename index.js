  ...
  const clear = () => {
    ...
    return(
        <div className="container">
           ...
           <div onClick={()=> display("/")} className="padButton div dg">/</div>
           <div onClick={()=> display("*")} className="padButton times dg">*</div>
           ...
           <div onClick={() => display("-")} className="padButton minus dg">-</div>
           ...
           <div onClick={() => display("+")} className="padButton plus dg">+</div>
